<template>
  <div class="about">
    <div class="about__content">
      <Text
        >Hi there 👋! My name is Laura, and I'm a passionate Web developer
        building end to end web applications. Here in my portfolio you can
        access my projects and achievments.
      </Text>
